...
# ==============================================================================
# CONFIGURACIÓN DE API KEYS Y SESIONES - PROTEGIDO PARA GITHUB Y RENDER
# ==============================================================================
# Si os.environ.get no encuentra la variable en Render, usa la clave por defecto (para tu PC local)
